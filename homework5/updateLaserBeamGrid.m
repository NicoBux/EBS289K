...
%% 
global bitmap;
persistent bitodds; % Local variable that stores the odds of each pixel in the map
...
bitodds(I2, J2) = bitodds(I2, J2)*19; % 95% probability => odds = 19
...
for k=1:length(l)-1 %skip the target pixel
     bitodds(l(k,1),l(k,2)) = bitodds(l(k,1),l(k,2))*0.05263; % free pixels
end
